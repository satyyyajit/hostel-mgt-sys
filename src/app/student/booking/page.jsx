...
const StudentRequestForm = () => {
    ...
    const validateFormData = () => {
        ...
        if (!selectedRoom) {
            toast.error("Selected room not found. Please reselect.");
            return false;
        }

        if (selectedRoom.roomType !== bedType) {
        ...
        const hostelBlock = (student.gender === 'Female') ? 'B1' : 'A1';
        if (selectedRoom.hostelBlock !== hostelBlock) {
            toast.error("Selected room does not match your gender's hostel block. Please reselect.");
            return false;
        }
